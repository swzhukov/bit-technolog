...
> **v0.8.5 готов к пилоту на 27 июля 2026.**
> **Текущая версия:** v0.8.5, **91/91 теста passing** (78 unit + 13 e2e), развёрнут на Beget VPS.
...
- [21-v0.8-design.md](docs/21-v0.8-design.md) — текущий
...
*Версия: v0.8.5. Дата: 2026-07-21. Тесты: 91/91. Pilot: 27 июля 2026.*
